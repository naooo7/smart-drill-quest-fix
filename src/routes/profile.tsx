...
import { getTargetInstitutionId, setTargetInstitutionId } from "@/services/profile-preferences";
...
function ProfilePage() {
  ...
  useEffect(() => setTargetId(getTargetInstitutionId()), []);
  const target = institutionById(targetId);
  const chooseInstitution = (institutionId: string) => {
    setTargetInstitutionId(institutionId);
    setTargetId(institutionId);
  };
